...
export default function Home () {
  ...
  <Carousel autoplay style={{width:'100%'}}>
    <div>
      ...
      <img style={{height:'600px'}} src='http://77.222.53.7:3003/carousel.001.jpeg'/>
    </div>
    <div>
    <img style={{height:'600px'}} src='http://77.222.53.7:3003/carousel.002.jpeg'/>
    </div>
    <div>

      <img style={{height:'600px'}} src='http://77.222.53.7:3003/carousel.003.jpeg'/>

    </div>
    <div>

      <img style={{height:'600px'}} src='http://77.222.53.7:3003/carousel.004.jpeg'/>
    </div>
    <div>

      <img style={{height:'600px'}} src='http://77.222.53.7:3003/carousel.005.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='http://77.222.53.7:3003/carousel.008.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='http://77.222.53.7:3003/carousel.006.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='http://77.222.53.7:3003/carousel.007.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='http://77.222.53.7:3003/carousel.009.jpg'/>
    </div>
  </Carousel>
  <div className='welcomeText'>
    <p className='welcomeTextTitle'>Кто мы?</p>
      ...
      <img className='logo' src='http://77.222.53.7:3003/Прозрачный фон (1).png'/>
</div>
...
<img className='img-how-we-do-it' src='http://77.222.53.7:3003/home.jpg'/>
  </div>
...
<div className='pluses-container'>
  ...
  <div className='pluses-body'>
    ...
    <img style={{opacity: "45%"}} src='http://77.222.53.7:3003/icons8-email-64.png' />
    <div className='one-plus'> Сайты знакомств менее эффективны и менее безопасны</div>
    <img style={{opacity: "45%"}} src='http://77.222.53.7:3003/icons8-rings-64.png' /> 
