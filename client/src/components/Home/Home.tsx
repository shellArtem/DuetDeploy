...
export default function Home () {
  ...
  useEffect(() => {
    (async function () {
      const response = await fetch("https://77.222.53.7:3003/news", {
        credentials: "include",
      });
  ...
  <Carousel autoplay style={{width:'100%'}}>
    <div>
      ...
      <img style={{height:'600px'}} src='https://77.222.53.7:3003/carousel.001.jpeg'/>
    </div>
    <div>
    <img style={{height:'600px'}} src='https://77.222.53.7:3003/carousel.002.jpeg'/>
    </div>
    <div>

      <img style={{height:'600px'}} src='https://77.222.53.7:3003/carousel.003.jpeg'/>

    </div>
    <div>

      <img style={{height:'600px'}} src='https://77.222.53.7:3003/carousel.004.jpeg'/>
    </div>
    <div>

      <img style={{height:'600px'}} src='https://77.222.53.7:3003/carousel.005.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='https://77.222.53.7:3003/carousel.008.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='https://77.222.53.7:3003/carousel.006.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='https://77.222.53.7:3003/carousel.007.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='https://77.222.53.7:3003/carousel.009.jpg'/>
    </div>
  </Carousel>
  <div className='welcomeText'>
    <p className='welcomeTextTitle'>Кто мы?</p>
      ...
      <img className='logo' src='https://77.222.53.7:3003/Прозрачный фон (1).png'/>
</div>
  <h3 style={{fontSize:'30px', marginTop: '10%', marginBottom: '5%'}}>Наши события и новости</h3>
  <div className='newsBody'>
  <div className='news'>{news.body}</div>
  <img className='newsPic' src={`https://77.222.53.7:3003${news.pic}`}/>
  </div>
...
<img className='img-how-we-do-it' src='https://77.222.53.7:3003/home.jpg'/>
  </div>
