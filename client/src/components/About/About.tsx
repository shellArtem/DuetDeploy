...
export default function About() {
  return (
    <div className={styles.main} >
        <img className={styles.mainPhoto} src='http://77.222.53.7:3003/IMG_2491 — копия.jpg'/>
...
<link href="https://fonts.googleapis.com/css2?family=Arsenal&family=Forum&family=Inconsolata:wght@400;500;600;800&family=Montserrat:ital,wght@1,200&family=Open+Sans:wght@500&family=REM:ital,wght@1,800&family=Roboto:wght@500&display=swap" crossOrigin="anonymous" rel="stylesheet"></link>
      ...
      <img className={styles.logo} src='http://77.222.53.7:3003/Прозрачный фон (1).png'/>
...
Мы сочетаем профессионализм и индивидуальный подход, чтобы учесть ваши пожелания и предпочтения.
          ...
          <img className={styles.logo3} src='http://77.222.53.7:3003/Прозрачный фон (1).png'/>
          </div>
          ...
          <img className={styles.logo4} src='http://77.222.53.7:3003/Прозрачный фон (1).png'/>
          ...
          <img className={styles.logo5} src='http://77.222.53.7:3003/Прозрачный фон (1).png'/>
  ...
  >
    <Image
      width={400}
      src="http://77.222.53.7:3003/Nadya.jpg"
    />
  </Image.PreviewGroup>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-around' }}>
        <div className={styles.contact}>
          ...
          <a href="tel:+79201083306">
            ...
            <p> <a href="https://wa.me/9206506055"><img  style={{width: '50px'}} src='http://77.222.53.7:3003/WhatsApp_Logo_1_t.png' /></a></p>
            <p > <a href="https://vk.com/marriegeagancy?z=article_edit-166046433_72908"> <img style={{width: '35px'}} src='http://77.222.53.7:3003/free-png.ru-307.png' /></a></p>
            <p> <a href="https://t.me/Nadya887"> <img style={{width: '40px'}} src='http://77.222.53.7:3003/telegram_cvet-d23c11fa.png' /></a></p>
            {/* </p> */}
