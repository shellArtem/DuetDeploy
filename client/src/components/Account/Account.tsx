...
// @ts-ignore
  ...
  useEffect(() => {
    (async function () {
      try {
        const resp = await fetch('https://77.222.53.7:3003/usersEvent', {
          method: 'GET',
          credentials: 'include',
        });
        ...
        const response = await fetch('https://77.222.53.7:3003/yookassaFeedback', {
          method: 'POST',
          credentials: 'include',
        });
  ...
  const sendFile = React.useCallback(async () => {
    ...
    const response = await axios.put('https://77.222.53.7:3003/profile', data, {
      headers: {
    ...
    const response2 = await axios.put(
      'https://77.222.53.7:3003/profile/2',
      data2,
      {
        headers: {
          'Content-Type': 'multipart/form-data',
  ...
  const logoutHandler = async () => {
    try {
      const response = await fetch('https://77.222.53.7:3003/logout', {
        credentials: 'include',
      });
          ...
          <div className="avatar">
            {photo ? (
              <img
                ...
                src={`https://77.222.53.7:3003/${photo}`}
                alt=""
              />
            ) : (
              <img
                ...
                src={'https://77.222.53.7:3003/avatar.png'}
                alt=""
              />
            )}
