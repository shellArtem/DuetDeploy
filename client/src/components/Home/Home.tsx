...
export default function Home () {
  ...
  useEffect(() => {
    (async function () {
      const response = await fetch("https://duet-marriage.ru:8443/news", {
        credentials: "include",
      });
  ...
  <Carousel autoplay style={{width:'100%'}}>
    <div>
      ...
      <img alt='индивидуальный подход к каждому клиенту' className='imgCarousel' src='https://duet-marriage.ru/carousel.001.jpeg'/>
    </div>
    <div>
    <img alt='соблюдение конфидециальности' className='imgCarousel' src='https://duet-marriage.ru/carousel.002.jpeg'/>
    </div>
    <div>

      <img alt='найти свою вторую половинку' className='imgCarousel' src='https://duet-marriage.ru/carousel.003.jpeg'/>

    </div>
    <div>

      <img alt='слышим пожелания каждого клиента' className='imgCarousel' src='https://duet-marriage.ru/carousel.004.jpeg'/>
    </div>
    <div>

      <img alt='объединяем одинокие сердца' className='imgCarousel' src='https://duet-marriage.ru/carousel.005.jpeg'/>
    </div>
    <div>
      <img alt='организуем незабываемое свидание' className='imgCarousel' src='https://duet-marriage.ru/carousel.008.jpeg'/>
    </div>
    <div>
      <img alt='мы ценим ваше доверие' className='imgCarousel' src='https://duet-marriage.ru/carousel.006.jpeg'/>
    </div>
    <div>
      <img alt='большая база клиентов' className='imgCarousel' src='https://duet-marriage.ru/carousel.007.jpeg'/>
    </div>
    <div>
      <img alt='найти любовь' className='imgCarousel' src='https://duet-marriage.ru/carousel.009.jpg'/>
    </div>
  </Carousel>
  <div className='welcomeText'>
    <p className='welcomeTextTitle'>Кто мы?</p>
      ...
      <img alt='брачное агентство "Дуэт" Рыбинск' className='logo' src='https://duet-marriage.ru/Прозрачный фон (1).png'/>
</div>
  <h3 style={{fontSize:'30px', marginTop: '10%', marginBottom: '5%'}}>Наши события и новости</h3>
  <div className='newsBody'>

  <div className='news'> <img alt='новость брачного агентства' className='newsPic' src={`https://duet-marriage.ru:8443${news.pic}`}/> {news.body}</div>
   </div>
...
<img alt='Сделайте первый шаг навстречу любви' className='img-how-we-do-it' src='https://duet-marriage.ru/home.jpg'/>
  </div>
...
<div className='pluses-container'>
  ...
  <div className='pluses-body'>
    ...
    <img alt='лучше сайта знакомств' style={{opacity: "45%"}} src='https://duet-marriage.ru/icons8-email-64.png' />
    <div className='one-plus'> Сайты знакомств менее эффективны и менее безопасны</div>
    <img alt='создание семьи' style={{opacity: "45%"}} src='https://duet-marriage.ru/icons8-rings-64.png' /> 
    <div className='two-plus'> Вы имеете серьезные намерения и желание создать семью</div>
    </div>
    <div className='table2'>
    <img alt='поиск пары' src='https://duet-marriage.ru/icons8-couple-64.png' style={{opacity: "45%"}}  />
    <div className='tree-plus'> У вас есть четкое представление о том, кто вам нужен</div>
    <img alt='серьезные отношения' src='https://duet-marriage.ru/icons8-key-64.png' style={{opacity: "45%"}} /> 
    <div className='four-plus'>Хотите отношений с надежным и благополучным человеком</div>
    </div>
    <div className='table3'>
    <img alt='найти вторую половину' src='https://duet-marriage.ru/icons8-calendar-64.png' style={{opacity: "45%"}} /> 
    <div className='five-plus'> Не хотите тратить время на поиски и общение с людьми, которые вам не подходят</div>
    <img alt='найти партнёра' src='https://duet-marriage.ru/icons8-heart-64.png' style={{opacity: "45%"}} /> 
