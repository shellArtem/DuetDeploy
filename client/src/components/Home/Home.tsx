...
export default function Home () {
  ...
  <Carousel autoplay style={{width:'100%'}}>
    ...
    <div>
      <img style={{height:'600px'}} src='/carousel.008.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='/carousel.006.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='/carousel.007.jpeg'/>
    </div>
    <div>
      <img style={{height:'600px'}} src='/carousel.009.jpg'/>
    </div>
  </Carousel>
  <div className='welcomeText'>
    <p className='welcomeTextTitle'>Кто мы?</p>
      ...
      <img className='logo' src='Прозрачный фон (1).png'/>
</div>
...
<img className='img-how-we-do-it' src='home.jpg'/>
  </div>
...
<div className='pluses-container'>
  ...
  <div className='pluses-body'>
    ...
    <img style={{opacity: "45%"}} src='icons8-email-64.png' />
    <div className='one-plus'> Сайты знакомств менее эффективны и менее безопасны</div>
    <img style={{opacity: "45%"}} src='icons8-rings-64.png' /> 
